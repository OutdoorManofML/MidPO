...
def get_optimizer_grouped_parameters(
    ...
    """Get parameter groups with customized weight decay value, compatible with LoRA."""
    ...
    # # only for the expert training
    # lora_params = [
    #     param for name, param in named_parameters if "lora" in name
    # ]
    # if lora_params:
    #     print("开始lora训练！")
    #     param_groups = [{
