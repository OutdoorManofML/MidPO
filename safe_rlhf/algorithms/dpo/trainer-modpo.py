...
class DPOTrainer(SupervisedTrainer):
    ...
    def loss(  # pylint: disable=too-many-locals
        ...
        for i in range(batch_size):
            ...
            safety_penalty = 1
            margin_loss = safety_penalty * (better_reward_loss - worse_reward_loss)
            print("margin_loss:", margin_loss)

            # New algorithm end
            # Safety Expert loss
            losses.append(-F.logsigmoid((2 * self.scale_coeff * (better_log_ratio - worse_log_ratio)) + margin_loss))
